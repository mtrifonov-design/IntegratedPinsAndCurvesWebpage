...
const H1 = (props: { children: React.ReactNode }) => <h1 style={{ fontSize: '2.5em', margin: '0.75em 0', fontFamily: "nudicamedium", color: "var(--gray8)" }}>{props.children}</h1>;
...
const P = (props: { children: React.ReactNode, style?: any }) => <p style={{ maxWidth: "600px", margin: "0",
    textAlign: "left",
    fontSize: "0.9em",
    ...props.style
 }}>{props.children}</p>;
